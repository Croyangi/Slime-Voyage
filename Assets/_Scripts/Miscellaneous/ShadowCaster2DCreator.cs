...
public class ShadowCaster2DCreator : MonoBehaviour
{
    ...
    public void Create()
    {
        ...
        for (int i = 0; i < tilemapCollider.pathCount; i++)
        {
            ...
            shadowCaster.isStatic = true;

            // Self-insert code, for culling
            //shadowCaster.layer = LayerMask.NameToLayer("IsPlayerCullable");
            //GameObject culledObjects = new GameObject("culledObjects");
            //culledObjects.transform.parent = shadowCaster.transform;

            // Add shadow caster inside culled objects
